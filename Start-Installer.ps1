...
$offlineWheelhouseOverride = Join-Path $root "assets\offline_wheelhouse.ps1"
...
if (-not (Test-Path -LiteralPath $offlineWheelhouseOverride)) { throw "Offline wheelhouse support script is missing: $offlineWheelhouseOverride" }
...
$replacementLines = @(
    ...
    '. (Join-Path $script:AssetsRoot "offline_wheelhouse.ps1")',
